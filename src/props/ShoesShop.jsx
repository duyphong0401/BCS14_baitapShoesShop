...
const ShoesShop = () => {
    ...
    let showDetail = (newShoesObj) => {
        console.log(newShoesObj)
        const modal = new window.bootstrap.Modal(document.getElementById('exampleModal'));
        modal.show();
        setShoesObj(newShoesObj)
    }
